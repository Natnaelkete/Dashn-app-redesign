...
export const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative pt-32 pb-24 overflow-hidden flex flex-col items-center justify-center bg-[#050811] bg-grid-fintech"
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-500/15 via-cyan-500/10 to-indigo-500/15 border border-blue-500/30 backdrop-blur-xl shadow-lg shadow-blue-500/10">
        ...
        <motion.p
          ...
          className="mt-6 text-base sm:text-lg lg:text-xl text-slate-300 max-w-2xl leading-relaxed font-normal"
        >
        ...
        <div className="w-full mt-14 sm:mt-18 perspective-[1500px] flex justify-center">
          <motion.div
            ...
            className="relative w-full max-w-[980px] rounded-[36px] sm:rounded-[44px] bg-gradient-to-b from-[#0e1628]/95 to-[#070b14]/95 border border-white/15 p-5 sm:p-9 shadow-2xl backdrop-blur-2xl overflow-hidden"
          >
            ...
            <div className="flex items-center justify-between pb-4 mb-6 border-b border-white/[0.08]">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-400 p-[1px]">
                  <div className="w-full h-full bg-[#080d16] rounded-[11px] flex items-center justify-center font-black text-white text-sm">
                    D
                  </div>
                </div>
              ...
              <div className="flex rounded-xl bg-slate-900/90 p-1 border border-white/[0.08]">
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-7 text-left">
                ...
                <div className="md:col-span-6 flex flex-col justify-between gap-5">
                  ...
                  <div className="grid grid-cols-4 gap-2.5 text-center">
                    {[
                      { label: "Send", icon: ArrowUpRight, action: () => setActiveTab("transfer"), color: "bg-blue-500/10 text-blue-400 border-blue-500/20" },
                      { label: "Pay QR", icon: QrCode, action: () => {}, color: "bg-cyan-500/10 text-cyan-400 border-cyan-500/20" },
                      { label: "Eqwub", icon: Users, action: () => {}, color: "bg-rose-500/10 text-rose-400 border-rose-500/20" },
                      { label: "USSD", icon: Zap, action: () => {}, color: "bg-amber-500/10 text-amber-400 border-amber-500/20" },
                    ].map((item) => (
                      <button
                        key={item.label}
                        onClick={item.action}
                  ...
                  <div className="space-y-2.5">
                    <div className="flex justify-between items-center text-xs text-slate-400">
                      <span className="font-semibold text-slate-300">Live Activity Feed</span>
                      <span className="text-xs text-emerald-400 font-mono">Real-Time Sync</span>
                    </div>

                    <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-white/[0.05] flex items-center justify-between text-xs sm:text-sm">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center">
                          <Plane className="w-5 h-5" />
                        </div>
                        <div>
                          <div className="font-semibold text-white">Ethiopian Airlines</div>
                          <div className="text-xs text-slate-400">Flight Ticket • ET-602</div>
                        </div>
                      </div>
                      <span className="font-mono font-bold text-slate-200">- ETB 4,200.00</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "transfer" && (
              <div className="max-w-lg mx-auto py-2 flex flex-col gap-4 text-left">
                <div className="p-4 rounded-2xl bg-blue-950/40 border border-blue-500/25 text-xs sm:text-sm text-blue-200">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-900 border border-white/15 rounded-xl px-4 py-3 text-sm font-mono font-bold text-white focus:outline-none focus:border-blue-500"
                ...
                {transferSuccess && (
                  <div className="p-3.5 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-emerald-300 text-xs sm:text-sm text-center flex items-center justify-center gap-2 font-mono">
